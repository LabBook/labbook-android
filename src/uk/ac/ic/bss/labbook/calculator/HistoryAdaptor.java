...
class HistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view;
        if (convertView == null) {
            view = mInflater.inflate(uk.ac.ic.bss.labbook.R.layout.history_item, parent, false);
        } else {
            view = convertView;
        }

        TextView expr   = (TextView) view.findViewById(uk.ac.ic.bss.labbook.R.id.historyExpr);
        TextView result = (TextView) view.findViewById(uk.ac.ic.bss.labbook.R.id.historyResult);
